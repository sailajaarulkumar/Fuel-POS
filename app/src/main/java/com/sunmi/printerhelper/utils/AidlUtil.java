...
public class AidlUtil {
     ...
     * 打印文字
     */
    public void printText(String content, float size, boolean isBold, boolean isUnderLine ,int align) throws RemoteException {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            if (isUnderLine) {
             ...
             //woyouService.sendRAWData(ESCUtil.fontsize(), null);
            // woyouService.sendRAWData(ESCUtil.font(), null);
             //woyouService.sendRAWData(ESCUtil.cpi(), null);
            woyouService.setAlignment(align, null);
            woyouService.printTextWithFont(content,null,size ,align,null);
    ...
    * 空打三行！
    ...
    public void printLeft(String c,boolean left, boolean right) throws RemoteException {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
        ...
        woyouService.printText(c, null);

    }
    public void printRight(String c){
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void print(String[] content, float size, boolean isBold, boolean isUnderLine) throws RemoteException {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
...
int[] widths={content[0].length(),content[1].length(),content[2].length()};
int[] aligns={2,1,0};
            Log.i("shoow", "print: "+content);
            //woyouService.sendRAWData(ESCUtil.fontsize(), null);
            // woyouService.sendRAWData(ESCUtil.font(), null);
            //woyouService.sendRAWData(ESCUtil.cpi(), null);
            //woyouService.setAlignment(align, null);
           // woyouService.printColumnsText(content ,widths,aligns,null);
            woyouService.lineWrap(3, null);
    ...
    public void print_left_right(String[] content, float size, boolean isBold, boolean isUnderLine) throws RemoteException {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            if(size>21)
            {
                m=34-(content[0].length()+content[1].length());
            }
          else
            {
                m=38-(content[0].length()+content[1].length());
            }
            ...
            woyouService.printTextWithFont(content[0] ,null,size,2,null);
            woyouService.printTextWithFont(resultString ,null,size,1,null);

            woyouService.printTextWithFont(content[1] ,null,size,0,null);
            woyouService.lineWrap(1, null);
